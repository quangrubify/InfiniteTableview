...
//		
//		UIView *tempImage = [self.mDelegate tfScroller:self viewForIndex:(i%mActualPages)];
//        tempImage.frame =CGRectMake(0, 0, mWidthPage, self.mScrollView.frame.size.height);
//		
